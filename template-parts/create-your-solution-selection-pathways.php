...
?>
<article data-type="<?php echo $post_type; ?>" class="column is-3-desktop all-products product-item <?php getPathwaysGrades(); ?><?php getPathwaysCategories(); ?><?php getPathwaysTags(); ?>" id="<?php echo $post_id; ?>">
...
?>
<article data-type="<?php echo $post_type; ?>" class="ng-hide column is-3-desktop stem-product-option all-products product-item <?php getProductGrades(); ?> <?php getProductCategories(); ?> <?php getProductTags(); ?>" id="<?php echo $post_id; ?>">
...
<?php
  endwhile;
      ...
      wp_reset_postdata();
// END OF PRODUCT QUERY POST DATA
