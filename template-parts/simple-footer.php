<?php
/**
 * Template part for displaying a Generic Footer
 * Includes Address, contact info, social links
 * TEQ TALK recent updates (2)
...
<footer class="site-footer padding-sm-left-right">
	<div>
		<div class="columns is-desktop">
			<div class="column is-5 hide-mobile margin-right">
				<h4 class="border-bottom"><span class="headline-title">Latest News From</span><br /><strong>Teq Talk</strong></h4>
				<br />
				<?php if ( have_posts() ) :
					$args = array(
						'post_status' => 'publish',
				...
				<article class="columns <?php foreach((get_the_category()) as $category) { echo $category -> slug; } ?>">
					...
					<div class="column">
						<h6 class="nomargin"><a href="<?php if(metadata_exists('post', $post->ID,'location')) { echo get_post_meta( $post->ID, 'location', true ); } else { the_permalink(); }; ?>"><?php the_title(); ?></a></h6>
						<small>
							<a class="relative-position strong" href="<?php if(metadata_exists('post', $post->ID,'bannerHeaderURL')) { echo get_post_meta( $post->ID, 'bannerHeaderURL', true ); } else { the_permalink(); }; ?>">[Read Article]</a>
						</small>
					</div>
				</article>
			...
			<div class="column is-6 is-12-mobile">
				<h4 class="border-bottom"><span class="headline-title">Questions or Comments?</span><br /><strong>877.455.9369</strong></h4>
				<p>7 Norden Lane | Huntington Station, NY 11746</p>
				<p class="caption" style="opacity:0.75;"><sup>	&copy;</sup>2020 - Teq<sup>&reg;</sup>, It’s all about learning.<sup>&trade;</sup>, iBlocks<sup>&trade;</sup>, evoSpaces<sup>&trade;</sup>, pBlocks<sup>&trade;</sup>, Teq Essentials<sup>&reg;</sup>, nOw Instructional Support<sup>&reg;</sup>, OPD Online Professional Development<sup>&reg;</sup>, Onsite Professional Development<sup>&reg;</sup>, and Powered by Teq<sup>&reg;</sup> are trademarks or registered trademarks of Tequipment, Inc. in the US. Other company names and product names appearing here are the trademarks and registered trademarks of their respective companies.</p>
				<svg id="social-icons" version="1.1" viewBox="0 0 396 100">
