...
?>
	...
	<div id="primary" class="content-area" scroll>
		<main id="main" class="site-main section-container">
			...
			<section class="section cdw-g-stem padding-top padding-bottom">
				<div class="container">
					<div class="columns is-vcentered">
						<div class="column is-6">
							<h1 class="condensed-text thin-heading less-line-height blue-text padding-right">ARE YOU READY TO CHOOSE THE TECHNOLOGY THAT WILL DIRECTLY IMPACT STUDENT OUTCOMES </h1>
			...
			<section class="container padding">
				<div class="columns is-desktop">
					<div class="column is-full">
						<h1 class="has-text-centered">The best in <strong>educational technology.</strong></h1>
					</div>
				</div>
			...
			<div class="columns is-vcentered">
          	...
          	<div class="column is-3">
            	...
            	<h5 class="nomargin"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h5>
							<p>
								<a class="relative-position strong" href="<?php the_permalink(); ?>">Read Article <span class="arrow"></span></a>
							</p>
          	</div>
					</article>
