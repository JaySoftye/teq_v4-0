...
<div id="primary" class="content-area">
	<main id="main" class="site-main container create-your-solution-container">
		<form id="products_search_form" name method="POST" action="<?php echo get_home_url(); ?>/create-your-solution/your-solution-results-printed" ng-controller="solutionController">
			      ...
			      <div class="box-section">
                          ...
                          $product_url = get_post_meta( get_the_ID(), 'custom_url_meta_content', true );
										  ...
										  <li class="solution-item">
												...
												<input type="checkbox" name="quoted_items[]" title="<?php echo $post_name ?>" value="<?php echo $post_id ?>" checked />
                              ...
                              <a href="<?php echo $pd_product_url; ?>" class="product-link" target="_blank">Learn More ›</a>
										  ...
										  <?php
										    endwhile; endif;
										      wp_reset_postdata();
                      ?>
                      <li id="smart-board-addition-panel" class="loading" style="display:none;">
                          ...
                          <div id="smartBoardSelections" class="solution-details" ng-show="accordionNameItem == 'smart_board_options'">
                            <?php $smart_args = array(
                              ...
                              if ($post_name == "smart-board-6000s") {
                                $click_ng = "smartboard7000r = 'false'; smartboard6000s = 'true'; smartboardmx = 'false';";
                                $show_ng = "smartboard6000s == 'true'";
                              } else if ($post_name == "smart-board-7000r") {
                                $click_ng = "smartboard7000r = 'true'; smartboard6000s = 'false'; smartboardmx = 'false';";
                                $show_ng = "smartboard7000r == 'true'";
                              } else if ($post_name == "smart-board-mx") {
                                $click_ng = "smartboard7000r = 'false'; smartboard6000s = 'false'; smartboardmx = 'true';";
                                $show_ng = "smartboardmx == 'true'";
                              }
    										   ?>
			...
			<div class="button-container form-action">
				<div class="container">
					...
					<div class="buttonGroup hide-tablet">
						<button type="submit" class="print">SAVE YOUR SOLUTION</button>
					</div>
				</div>
			</div>
		</form>
