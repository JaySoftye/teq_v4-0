				...
				<div class="column is-full filter-results">
					<div class='columns is-multiline'>
						...
						<?php if ( have_posts() ) :
							...
							<article class="<?php echo the_title() . ' '; echo implode( ' ', $terms ); ?> column is-three-quarters-mobile is-one-third-tablet is-one-quarter-desktop is-one-quarter-widescreen is-one-quarter-fullhd product-item">
