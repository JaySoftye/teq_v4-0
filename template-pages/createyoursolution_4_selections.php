<?php
/**
 * Template Name: Create Your Solution 4.0 Grade and STEM Focus
				...
				<section id="stemFields" class="columns is-multiline is-centered is-vcentered is-desktop hidden">
					<div class="column is-full-desktop is-full-mobile">
						...
						<div class="padding-bottom has-text-centered">
							...
							<h5>Next, we’ll zero in on your area of interest. <strong>Using the dial below,</strong> choose the STEM-based subject matter<br />that best suits your interests.If you would like to choose a different grade level <button type="button" onclick="gradeSelection()" class="button blank"><u>click here</u></button>.</h5>
						</div>
